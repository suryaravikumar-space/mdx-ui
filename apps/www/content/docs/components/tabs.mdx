...
<Tabs defaultValue="npm">
  ...
  <TabsContent value="npm">
    \`\`\`bash npm install docsui-cli \`\`\`
  </TabsContent>
  <TabsContent value="pnpm">\`\`\`bash pnpm add docsui-cli \`\`\`</TabsContent>
  <TabsContent value="yarn">\`\`\`bash yarn add docsui-cli \`\`\`</TabsContent>
</Tabs>
```
