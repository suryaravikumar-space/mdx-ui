...
mdx-ui is a collection of 22 ready-to-use MDX components for documentation sites. Components are copied directly into your project — not installed as a dependency — so you own the code and can modify it freely.
...
### Code & Math
[Code Block](/docs/components/code-block) · [Inline Code](/docs/components/inline-code) · [Math](/docs/components/math) · [Mermaid](/docs/components/mermaid)
