...
```bash
pnpm dlx @docsui-cli/cli@latest init
```
...
```bash
yarn dlx @docsui-cli/cli@latest init
```
...
```bash
pnpm dlx @docsui-cli/cli@latest add callout accordion code-block
```
...
```bash
yarn dlx @docsui-cli/cli@latest add callout accordion code-block
```
