...
description: Learn how to integrate DocsUI components with your project
published: true
---

## Overview

DocsUI provides beautifully designed components for your MDX content. After installing components with the CLI, you need to set up an MDX renderer to use them in your markdown files.

## Prerequisites

Before integrating DocsUI, make sure you have:
...
DocsUI works with any MDX renderer. Follow the guide for your setup:
...
npx docsui-cli@latest add callout headings paragraph
```
...
import { H1, H2, H3 } from "@/components/docsui/headings";
...
- [test-app](https://github.com/suryaravikumar-space/docsui/tree/main/test-app) - Next.js with next-mdx-remote
- [DocsUI documentation](https://github.com/suryaravikumar-space/docsui/tree/main/apps/www) - Next.js with contentlayer
...
- [View Examples](https://github.com/suryaravikumar-space/docsui/tree/main/test-app)
- [Report Issues](https://github.com/suryaravikumar-space/docsui/issues)

## Next Steps

1. Choose your MDX renderer
2. Follow the integration guide
3. Start building with DocsUI!
