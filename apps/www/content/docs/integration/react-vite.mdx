...
<CodeGroup>
  ```bash title="npm" npx @ravikumarsurya/mdx-ui add math-primitives
  math-solution ``` ```bash title="pnpm" pnpm dlx @ravikumarsurya/mdx-ui add
  math-primitives math-solution ``` ```bash title="yarn" yarn dlx
  @ravikumarsurya/mdx-ui add math-primitives math-solution ```
</CodeGroup>
