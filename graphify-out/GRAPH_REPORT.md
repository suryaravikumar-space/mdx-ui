...
- [[_COMMUNITY_Data Structures Visualization Source|Data Structures Visualization Source]]
- [[_COMMUNITY_Data Structures Visualization Docs|Data Structures Visualization Docs]]
- [[_COMMUNITY_Tree Data Structures Source|Tree Data Structures Source]]
- [[_COMMUNITY_Tree Data Structures Docs|Tree Data Structures Docs]]
- [[_COMMUNITY_Next.js App Routing and Navigation|Next.js App Routing and Navigation]]
- [[_COMMUNITY_Mermaid Diagrams Source|Mermaid Diagrams Source]]
- [[_COMMUNITY_Mermaid Diagrams Docs|Mermaid Diagrams Docs]]
- [[_COMMUNITY_Remark MDX Plugin|Remark MDX Plugin]]
- [[_COMMUNITY_Simple Inline Components (UtilsEmphasisHighlight)|Simple Inline Components (Utils/Emphasis/Highlight)]]
- [[_COMMUNITY_App Layouts and Sidebar|App Layouts and Sidebar]]
- [[_COMMUNITY_Docs Hub (InstallationIndex)|Docs Hub (Installation/Index)]]
- [[_COMMUNITY_Project Design Principles|Project Design Principles]]
- [[_COMMUNITY_Badge and Annotation Docs|Badge and Annotation Docs]]
- [[_COMMUNITY_CLI AddUpdate Commands|CLI Add/Update Commands]]
- [[_COMMUNITY_ComponentPreview and Demo Sources|ComponentPreview and Demo Sources]]
- [[_COMMUNITY_Content Block Component Docs|Content Block Component Docs]]
- [[_COMMUNITY_CLI Init Command|CLI Init Command]]
- [[_COMMUNITY_CodeLinkVideo Demos|Code/Link/Video Demos]]
- [[_COMMUNITY_CLI MCP and New Commands|CLI MCP and New Commands]]
...
- [[_COMMUNITY_Developer Guides|Developer Guides]]
- [[_COMMUNITY_Heading Component Source|Heading Component Source]]
- [[_COMMUNITY_Heading Component Docs|Heading Component Docs]]
- [[_COMMUNITY_CLI Doctor and Registry|CLI Doctor and Registry]]
- [[_COMMUNITY_Table Component Source|Table Component Source]]
...
4. `clsx Dependency` - 19 edges
5. `tailwind-merge Dependency` - 19 edges
6. `utils Registry Dependency` - 19 edges
7. `mdx-ui Documentation Index` - 19 edges
8. `check` - 15 edges
9. `packages/registry/src (Component Source)` - 14 edges
...
- **CLI Commands (init, add, list)** — cli_init_command, cli_add_command, cli_list_command [EXTRACTED 1.00]
- **CLI Utilities (fetch-component, get-config, install-deps, write-component)** — cli_fetch_component, cli_get_config, cli_install_deps, cli_write_component [EXTRACTED 1.00]
- **All Sidebar JSON Files (docs, learn, reference, blog, community)** — sidebar_docs_json, sidebar_learn_json, sidebar_reference_json, sidebar_blog_json, sidebar_community_json [EXTRACTED 1.00]
- **Monorepo Packages (cli, registry, www)** — readme_packages_cli, readme_packages_registry_src, readme_apps_www [EXTRACTED 1.00]
- **Navigation Utility Functions (getAllRoutes, getBreadcrumbs, getAdjacentRoutes)** — nav_getallroutes, nav_getbreadcrumbs, nav_getadjacentroutes [EXTRACTED 1.00]
- **Component MDX Documentation Pages (accordion, alert, annotation, badge)** — accordion_mdx_doc, alert_mdx_doc, annotation_mdx_doc, badge_mdx_doc [EXTRACTED 1.00]
- **Components Dependent on utils (accordion, annotation, badge)** — comp_accordion, comp_annotation, comp_badge, comp_utils [EXTRACTED 1.00]
- **Components Depending on utils Registry** — callout_component, certification_badge_component, code_block_component, complexity_table_component, data_type_table_component, definition_component, file_tree_component, glossary_component, hardware_spec_component, heading_component, utils_registry_dep [EXTRACTED 1.00]
- **Components Using clsx and tailwind-merge** — callout_component, certification_badge_component, complexity_table_component, data_type_table_component, definition_component, glossary_component, hardware_spec_component, heading_component, clsx_dep, tailwind_merge_dep [EXTRACTED 1.00]
- **Components Using class-variance-authority** — callout_component, heading_component, class_variance_authority [EXTRACTED 1.00]
- **Code Highlighting Pipeline (rehype-pretty-code + Shiki)** — code_block_component, code_group_component, rehype_pretty_code, shiki_highlighter [EXTRACTED 1.00]
- **Tabular Data Display Components** — data_table_component, data_type_table_component, complexity_table_component [INFERRED 0.85]
- **Glossary Provider and Term Pair** — glossary_provider_subcomponent, term_subcomponent, react_context_pattern [EXTRACTED 1.00]
- **Image Framework Integration Options** — image_renderer_provider, next_image, astro_assets [EXTRACTED 1.00]
- **Inline Typography Components** — emphasis_component, highlight_component, inline_code_component [INFERRED 0.75]
- **Heading Hierarchy Components** — heading_component, headings_component, heading_h1_h6_variants [INFERRED 0.85]
- **Code Display Components** — code_block_component, code_group_component, diff_block_component, inline_code_component [INFERRED 0.85]
- **Structure Display Components** — file_tree_component, card_component, changelog_component [INFERRED 0.75]
- **Components depending on clsx and tailwind-merge** — invariant_component, paragraph_component, preview_component, privacy_table_component, register_map_component, reveal_component, security_note_component, steps_component, clsx_dep, tailwind_merge_dep [EXTRACTED 1.00]
- **Components with utils registry dependency** — invariant_component, paragraph_component, preview_component, privacy_table_component, register_map_component, reveal_component, security_note_component, steps_component, tree_component, utils_registry_dep [EXTRACTED 1.00]
- **Mermaid data structure visualization subcomponents** — mermaid_component, mermaid_bst_subcomponent, mermaid_bfs_subcomponent, mermaid_dfs_subcomponent, mermaid_tree_subcomponent [EXTRACTED 1.00]
- **Frameworks supported by mdx-ui** — mdxui_cli, nextjs_framework, astro_framework, vite_react_framework [EXTRACTED 1.00]
- **Collapsible disclosure components (Spoiler, Reveal, Accordion)** — spoiler_component, reveal_component, accordion_component [INFERRED 0.85]
- **MDX Renderer Integration Documentation Set** — doc_nextjs_mdx_remote_mdx, doc_nextjs_contentlayer_mdx, doc_nextjs_mdx_mdx, doc_component_mappings_mdx, doc_integration_index_mdx [EXTRACTED 1.00]
- **Component Design and Planning Documents** — doc_component_api_conventions, doc_component_names_reference, doc_component_roadmap, doc_react_dev_components_analysis, doc_basic_markdown_components [INFERRED 0.95]
- **Registry Build and Distribution System** — doc_registry_pkg_readme, doc_registry_readme, doc_scripts_readme, concept_build_registry_workflow, concept_registry_json_format [EXTRACTED 1.00]
- **v0.1.0 Foundation Architecture Concepts** — concept_testing_infrastructure, concept_design_primitives, concept_collapse_animation, concept_mdx_native_components, concept_framework_neutrality, concept_cicd_pipeline [EXTRACTED 1.00]
- **AI Content Generation and Rendering Pipeline** — concept_ai_content_pipeline, concept_preprocess_markdown, concept_remark_mdx_ui_plugin, concept_system_prompt_llm, concept_mdx_component_mapping [EXTRACTED 1.00]
...
- **Why does `class-variance-authority` connect `Content Block Component Docs` to `Community 67`, `Community 90`, `Community 70`, `Community 105`, `Community 44`, `ComponentPreview and Demo Sources`, `Community 62`, `Heading Component Source`, `Heading Component Docs`, `Community 94`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `Callout Component` connect `Content Block Component Docs` to `Badge and Annotation Docs`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **What connects `__filename`, `__dirname`, `componentsMetadata` to the rest of the system?**
  _729 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Docs Site MDX Component Wrappers` be split into smaller, more focused modules?**
  _Cohesion score 0.03 - nodes in this community are weakly interconnected._
- **Should `Math Primitives Source` be split into smaller, more focused modules?**
  _Cohesion score 0.01 - nodes in this community are weakly interconnected._
- **Should `Interactive Components (Accordion/Reveal/Annotation)` be split into smaller, more focused modules?**
