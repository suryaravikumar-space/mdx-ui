...
describe("Definition", () => {
  it("renders the term label", () => {
    render(<Definition term="Invariant">A condition that always holds.</Definition>)
    expect(screen.getByText("Invariant")).toBeInTheDocument()
  })

  it("renders the definition body", () => {
    render(<Definition term="Invariant">A condition that always holds.</Definition>)
    expect(screen.getByText("A condition that always holds.")).toBeInTheDocument()
  })
  ...
  it("applies custom className", () => {
    const { container } = render(
      <Definition term="Term" className="custom-class">body</Definition>
    )
  ...
  it("forwards ref to root div", () => {
    ...
    render(<Definition term="Term" ref={ref}>body</Definition>)
  ...
  it("passes through additional HTML attributes", () => {
    const { container } = render(
      <Definition term="Term" data-testid="def-block">body</Definition>
    )
