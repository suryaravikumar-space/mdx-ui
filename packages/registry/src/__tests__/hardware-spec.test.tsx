...
describe("HardwareSpec", () => {
  ...
  it("renders provided fields", () => {
    ...
    expect(
      screen.getByText("Peripheral Component Interconnect Express"),
    ).toBeInTheDocument();
  ...
  it("renders description when provided", () => {
    ...
    expect(
      screen.getByText("Serial communication for debug console output."),
    ).toBeInTheDocument();
  });
  ...
  it("accepts className", () => {
    const { container } = render(
      <HardwareSpec name="USB" className="custom-class" />,
    );
