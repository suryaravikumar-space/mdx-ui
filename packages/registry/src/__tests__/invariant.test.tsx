...
describe("Invariant", () => {
  it("renders the invariant statement", () => {
    render(<Invariant>An AVL tree remains balanced after every operation.</Invariant>)
    expect(screen.getByText("An AVL tree remains balanced after every operation.")).toBeInTheDocument()
  })
  ...
  it("applies custom className", () => {
    const { container } = render(<Invariant className="custom">statement</Invariant>)
